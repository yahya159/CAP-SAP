...
export const referenceData = [
  ...
  { id: 'ref-5', type: 'TICKET_STATUS', code: 'NEW', label: 'New', active: true, order: 1 },
  { id: 'ref-6', type: 'TICKET_STATUS', code: 'IN_PROGRESS', label: 'In Progress', active: true, order: 2 },
  { id: 'ref-7', type: 'TICKET_STATUS', code: 'DONE', label: 'Done', active: true, order: 3 },
