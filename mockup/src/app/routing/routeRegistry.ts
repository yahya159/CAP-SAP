    ...
    routes: [
      {
        id: 'admin-dashboard',
        path: 'dashboard',
        lazy: lazyNamed(() => import('../pages/admin/AdminDashboard'), 'AdminDashboard'),
        nav: { label: 'Dashboard', iconKey: 'shield' },
      },
      {
        id: 'admin-users',
        path: 'users',
        lazy: lazyNamed(() => import('../pages/admin/UsersManagement'), 'UsersManagement'),
        nav: { label: 'Users', iconKey: 'users' },
      },
      {
        id: 'admin-reference-data',
        path: 'reference-data',
        lazy: lazyNamed(() => import('../pages/admin/ReferenceData'), 'ReferenceDataManagement'),
    ...
    routes: [
      {
        ...
        path: 'dashboard',
        lazy: lazyNamed(() => import('../pages/manager/ManagerDashboard'), 'ManagerDashboard'),
        nav: { label: 'Performance', iconKey: 'bar-chart-3' },
      },
      {
        id: 'manager-projects',
        path: 'projects',
        lazy: lazyNamed(() => import('../pages/manager/ProjectsEnhanced'), 'ProjectsEnhanced'),
        nav: { label: 'Projects', iconKey: 'folder-kanban' },
      },
      {
        id: 'manager-project-details',
        path: 'projects/:id',
        lazy: lazyNamed(() => import('../pages/manager/ProjectDetails'), 'ProjectDetails'),
      },
      {
        id: 'manager-team',
        path: 'team',
        lazy: lazyNamed(() => import('../pages/manager/TeamPerformance'), 'TeamPerformance'),
        nav: { label: 'Team', iconKey: 'users' },
      },
      {
        id: 'manager-allocations',
        path: 'allocations',
        lazy: lazyNamed(() => import('../pages/manager/ResourceAllocation'), 'ResourceAllocation'),
        nav: { label: 'Allocations', iconKey: 'layout-dashboard' },
      },
      {
        id: 'manager-risks',
        path: 'risks',
        lazy: lazyNamed(() => import('../pages/manager/RisksAndCriticalTasks'), 'RisksAndCriticalTasks'),
        nav: { label: 'Risks', iconKey: 'triangle-alert' },
      },
      {
        id: 'manager-tickets',
        path: 'tickets',
        lazy: lazyNamed(() => import('../pages/manager/ManagerTickets'), 'ManagerTickets'),
      ...
      },
      {
        id: 'manager-objects',
        path: 'objects',
        lazy: lazyNamed(() => import('../pages/shared/DocumentationObjectsPage'), 'DocumentationObjectsPage'),
      ...
      },
      {
        ...
        path: 'certifications',
        lazy: lazyNamed(() => import('../pages/manager/CertifiedConsultants'), 'CertifiedConsultants'),
        nav: { label: 'Certifications', iconKey: 'award' },
      },
      {
        id: 'manager-leave',
        path: 'leave',
        lazy: lazyNamed(() => import('../pages/manager/GestionConges'), 'GestionConges'),
        nav: { label: 'Leave', iconKey: 'calendar-days' },
      },
      {
        id: 'manager-imputations',
        path: 'imputations',
        lazy: lazyNamed(() => import('../pages/manager/ImputationsEquipe'), 'ImputationsEquipe'),
    ...
    routes: [
      {
        id: 'tech-dashboard',
        path: 'dashboard',
        lazy: lazyNamed(() => import('../pages/consultant-tech/TechDashboard'), 'TechDashboard'),
        nav: { label: 'Dashboard', iconKey: 'gauge' },
      },
      {
        id: 'tech-projects',
        path: 'projects',
        lazy: lazyNamed(() => import('../pages/consultant-tech/MyProjects'), 'MyProjects'),
        nav: { label: 'Projects', iconKey: 'folder-kanban' },
      },
      {
        id: 'tech-tickets',
      ...
      },
      {
        id: 'tech-leave',
        path: 'leave',
        lazy: lazyNamed(() => import('../pages/consultant-tech/MesConges'), 'MesConges'),
        nav: { label: 'Leave', iconKey: 'calendar-days' },
      },
      {
        id: 'tech-imputations',
        path: 'imputations',
        lazy: lazyNamed(() => import('../pages/consultant-tech/MesImputations'), 'MesImputations'),
        nav: { label: 'Imputations', iconKey: 'clock' },
      },
      {
        id: 'tech-objects',
    ...
    routes: [
      {
        id: 'func-dashboard',
        path: 'dashboard',
        lazy: lazyNamed(() => import('../pages/consultant-func/FuncDashboard'), 'FuncDashboard'),
        nav: { label: 'Dashboard', iconKey: 'gauge' },
      },
      {
        id: 'func-projects',
        path: 'projects',
        lazy: lazyNamed(() => import('../pages/consultant-func/Projects'), 'FuncProjects'),
        nav: { label: 'Projects', iconKey: 'folder-kanban' },
      },
      {
        id: 'func-deliverables',
        path: 'deliverables',
        lazy: lazyNamed(() => import('../pages/consultant-func/Deliverables'), 'Deliverables'),
        nav: { label: 'Deliverables', iconKey: 'wrench' },
      },
      {
        id: 'func-tickets',
        path: 'tickets',
        lazy: lazyNamed(() => import('../pages/consultant-func/Tickets'), 'FuncTickets'),
        nav: { label: 'Tickets', iconKey: 'ticket' },
      },
      {
    ...
    routes: [
      {
        id: 'pm-dashboard',
        path: 'dashboard',
        lazy: lazyDefault(() => import('../pages/project-manager/ProjectManagerDashboard')),
        nav: { label: 'Dashboard', iconKey: 'gauge' },
      },
      {
        id: 'pm-projects',
      ...
      },
      {
        id: 'pm-imputations',
        path: 'imputations',
        lazy: lazyNamed(() => import('../pages/project-manager/PMImputations'), 'PMImputations'),
        nav: { label: 'Imputations', iconKey: 'clock' },
      },
    ],
  }),
    ...
    routes: [
      {
        ...
        path: 'dashboard',
        lazy: lazyDefault(() => import('../pages/dev-coordinator/DevCoordinatorDashboard')),
        nav: { label: 'Dashboard', iconKey: 'gauge' },
      },
      {
      ...
      },
      {
        ...
        path: 'ai-dispatch',
        lazy: lazyDefault(() => import('../pages/dev-coordinator/AIDispatchPage')),
        nav: { label: 'AI Dispatch', iconKey: 'sparkles' },
      },
      {
        id: 'dev-coord-workload',
        path: 'workload',
        lazy: lazyDefault(() => import('../pages/dev-coordinator/WorkloadPage')),
        nav: { label: 'Workload', iconKey: 'bar-chart-3' },
      },
      {
        id: 'dev-coord-imputations',
        path: 'imputations',
        lazy: lazyNamed(() => import('../pages/dev-coordinator/DevCoordImputations'), 'DevCoordImputations'),
        nav: { label: 'Imputations', iconKey: 'clock' },
      },
    ],
  }),
...
export const SHARED_ROUTE_REGISTRY: SharedRouteDefinition[] = [
  {
    id: 'shared-profile',
    path: 'profile',
    lazy: lazyNamed(() => import('../pages/shared/Profile'), 'ProfilePage'),
  },
  {
    id: 'shared-settings',
    path: 'settings',
    lazy: lazyNamed(() => import('../pages/shared/Settings'), 'SettingsPage'),
  },
  {
    id: 'shared-documentation-details',
    path: 'shared/documentation/:id',
    lazy: lazyNamed(() => import('../pages/shared/DocumentationDetails'), 'DocumentationDetails'),
  },
];
