...
import { useProjectWricefObjects, useProjectTickets, useProjectDocumentation } from '../queries';
import { WricefType, TicketComplexity, SAPModule, WricefObject } from '@/app/types/entities';
import { filterProjectObjects, paginateItems, buildWricefObjectTicketStats, WRICEF_TYPE_BADGE_CLASS, COMPLEXITY_BADGE_CLASS, WRICEF_STATUS_COLOR, WRICEF_PRIORITY_COLOR } from '../model';
